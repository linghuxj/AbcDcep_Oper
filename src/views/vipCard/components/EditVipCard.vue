<template>
  <div class="business">
    <el-form ref="form" :model="form" :rules="rules" label-width="10rem" class="demo-ruleForm">
      <el-form-item label="会员卡类型：" prop="typeId">
        <el-select v-model="form.typeId" placeholder="请选择会员卡类型" style="width: 30%">
          <el-option
      ...
      <el-form-item label="会员卡名称：" prop="name">
        <el-input v-model="form.name" placeholder="请输入会员卡名称" style="width: 40%" />
      </el-form-item>
      <el-form-item label="有效期：" prop="expiryDate">
        <el-input v-model.number="form.expiryDate" placeholder="请输入数值" style="width: 15%" />
        <el-select v-model="form.expiryDateType" placeholder="请选择单位" style="width: 15%">
          <el-option
      ...
      <el-form-item label="售价（元）：" prop="price">
        <el-input v-model.number="form.price" placeholder="请输入售价（元）" maxlength="11" style="width: 40%" />
      </el-form-item>
      <el-form-item label="使用平台：" prop="platform">
        <el-select v-model="form.platform" placeholder="请选择使用平台" style="width: 40%">
          <el-option
      ...
      <el-form-item label="使用须知：" prop="cardDesc">
        <el-input v-model="form.cardDesc" type="textarea" placeholder="请输入会员卡的使用说明" maxlength="1000" style="width: 50%" />
      </el-form-item>
      <el-form-item>
