    ...
    <div class="orderDetail-main-top">
      ...
      <div class="main-top-content">
        ...
        <div class="main-top-item">
          ...
          <div>
            提货人电话：{{
              detailForm.orderTake ? detailForm.orderTake.mobile : '--'
            }}
          </div>
          <div>
            提货码：{{
              detailForm.orderTake ? detailForm.orderTake.takeNo : '--'
            }}
          </div>
        </div>
        <div class="main-top-item">
          ...
          <div>
            提货时间：{{
              detailForm.orderTake && detailForm.orderTake.takeTime
                ? detailForm.orderTake.takeTime
                : '--'
            }}
          </div>
          <div>-</div>
      ...
      <div class="main-table">
        ...
        >
          ...
          <el-table-column label="优惠券优惠(元)">
            <template slot-scope="scope">
              <span>{{
                scope.row.couponAmount ? scope.row.couponAmount : '--'
              }}</span>
            </template>
          </el-table-column>
