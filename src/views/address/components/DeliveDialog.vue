<template>
  <div>
    <!-- 编辑和添加弹框 -->
    <el-dialog
      :title="editOrAdd==='Add'?'新增发货地址':'编辑发货地址'"
      ...
      <el-form 
        ...
        <el-form-item label="发货人：" :label-width="formLabelWidth" prop="name">
          <el-input v-model="ruleForm.name" placeholder="请输入发货人姓名"></el-input>
        </el-form-item>
