<template>
  <div class="business">
    <el-form :inline="true" :model="search" class="demo-form-inline">
      <el-form-item label="嗨PRO卡名称">
        <el-input v-model="search.name" placeholder="请输入内容"></el-input>
      </el-form-item>
      <el-form-item label="状态" prop="type">
        <el-select v-model="search.status" placeholder="请选择嗨PRO卡状态">
          <el-option
    ...
    <div>
      <el-button type="primary" @click="addcompile">添加嗨PRO卡</el-button>
    </div>
    <div style="margin-top: 10px">
      ...
      >
        ...
        <el-table-column prop="name" label="嗨PRO名称">
        </el-table-column>
        ...
        <el-table-column prop="price" label="售卖金额（元）"> </el-table-column>
        ...
        <el-table-column label="操作" width="220">
          <template slot-scope="scope">
            ...
            <!--<el-button size="mini" type="danger" @click="forbid(scope.row.id)">禁用</el-button> -->
            <!-- <el-button size="mini" type="text" @click="handleLookCoupon(scope.row.id)">查看</el-button> -->
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
...
export default {
  ...
  methods: {
    ...
    handleEdit(id) {
      ...
      this.$router.push('/hipro/lists/compile?id=' + id)
    },
    // 添加
    addcompile() {
      this.$router.push('/hipro/lists/establish')
    },
    //页容量改变
